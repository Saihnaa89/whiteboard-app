...
export const DrawingCanvas = ({ roomId }) => {
    ...
    return (<div className="drawing-canvas">
      <div className="toolbar">
        <div className="color-picker">
          <button onClick={() => handleColorChange('#000000')} style={{ backgroundColor: '#000000' }}/>
          <button onClick={() => handleColorChange('#FF0000')} style={{ backgroundColor: '#FF0000' }}/>
          <button onClick={() => handleColorChange('#00FF00')} style={{ backgroundColor: '#00FF00' }}/>
          <button onClick={() => handleColorChange('#0000FF')} style={{ backgroundColor: '#0000FF' }}/>
        </div>
